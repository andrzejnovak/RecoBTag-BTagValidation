...
campaigns       = [ 
                    ...
                    # ,'Run2017DDBvL_NTRACKS'
                     ...
                     # ,'Run2017DeepAK8ZHbb_BFRAGUP'
                     # ,'Run2017DeepAK8ZHbb_BFRAGDOWN'
                     # ,'Run2017DeepAK8ZHbb_PUUP'
                     # ,'Run2017DeepAK8ZHbb_PUDOWN'                    
                     # ,'Run2017DeepAK8ZHbb_K0L'
                     # ,'Run2017DeepAK8ZHbb_CDFRAG'
                     # ,'Run2017DeepAK8ZHbb_CFRAG'
                    # ,'Run2017DeepAK8ZHbb_NTRACKS'

                     # ,'Run2017DDCvL_BFRAGUP'
                     # ,'Run2017DDCvL_BFRAGDOWN'
                     # ,'Run2017DDCvL_PUUP'
                     # ,'Run2017DDCvL_PUDOWN'                    
                     # ,'Run2017DDCvL_K0L'
                     # ,'Run2017DDCvL_CDFRAG'
                     # ,'Run2017DDCvL_CFRAG'
                    # ,'Run2017DDCvL_NTRACKS'

                     #  'Run2016DeepAK8ZHbb_BFRAGUP'
                     # ,'Run2016DeepAK8ZHbb_BFRAGDOWN'
                     # ,'Run2016DeepAK8ZHbb_PUUP'
                     # ,'Run2016DeepAK8ZHbb_PUDOWN'                    
                     # ,'Run2016DeepAK8ZHbb_K0L'
                     # ,'Run2016DeepAK8ZHbb_CDFRAG'
                     # ,'Run2016DeepAK8ZHbb_CFRAG'
                    #,'Run2017DeepAK8ZHbb_NTRACKS'


                    #,'Run2016DDCvL_BFRAGUP'
                    #,'Run2016DDCvL_BFRAGDOWN'
                    #,'Run2016DDCvL_PUUP'
                    #,'Run2016DDCvL_PUDOWN'                    
                    #,'Run2016DDCvL_K0L'
                    #,'Run2016DDCvL_CDFRAG'
                    #,'Run2016DDCvL_CFRAG'
                    #,'Run2016DDCvL_NTRACKS'
                    ...
                    #,'Run2017DDBvL_NTRACKS'
                     ...
                     'Run2018DoubleB'
                     ,'Run2018DoubleB_BFRAGUP'
                     ,'Run2018DoubleB_BFRAGDOWN'
                     ,'Run2018DoubleB_PUUP'
                     ,'Run2018DoubleB_PUDOWN'                    
                     ,'Run2018DoubleB_K0L'
                     ,'Run2018DoubleB_CDFRAG'
                     ,'Run2018DoubleB_CFRAG'
                     ,'Run2018DoubleB_MCJP'
                    # ,'Run2016DoubleB_NTRACKS'

                     ,'Run2018DDBvL'
                     ,'Run2018DDBvL_BFRAGUP'
                     ,'Run2018DDBvL_BFRAGDOWN'
                     ,'Run2018DDBvL_PUUP'
                     ,'Run2018DDBvL_PUDOWN'                    
                     ,'Run2018DDBvL_K0L'
                     ,'Run2018DDBvL_CDFRAG'
